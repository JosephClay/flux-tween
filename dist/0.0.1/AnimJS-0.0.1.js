...
<%= pkg.homepage ? " * " + pkg.homepage + "\n" : "" %> * Copyright (c) 2012-<%= grunt.template.today("yyyy") %> <%= pkg.author.name %>; License: <%= licenses %> */
...
var _canHwAccel = (_styles.animationDuration && _styles.animationKeyFrame && _styles.animationName && _styles.animationTimingFunction),
	_canAnimate = !!_styles.transform;
